/*
  To do list:
    ...
    (1) After 100 flag passes, show score and high score screen.
    (2) After 3 lives lost, show Boris dead screen (done, just got to get it to reset game)
    (3) Reset Boris dead screen and score screen with "a" button to start a new game.
    (4) Work out why Boris disapears from screen after several presses of left button, I've disabled full left animation on Boris for now as a workaround.
